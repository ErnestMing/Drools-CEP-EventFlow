package cn.com.fusio.event.raw;
...
/**
 * @Description: 平安教化-内容-PV 事件
 * @Author : Ernest
 * @Date : 2017/8/21 11:35
 */
public class PinganBehaviorData {
    ...
    public PinganBehaviorData(){}

    public PinganBehaviorData(String app_id, String domain_userid, String domain_sessionid, String domain_sessionidx, String event_name, String page_urlhost, String page_url, String page_urlquery, String geo_country, String geo_region_name, String geo_city, String br_name, String dvce_type, Date collector_tstamp ) {
        this.app_id = app_id;
